...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060300').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060301').click(function () {     /* START of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-t06-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--t06-03').offset().top -60}, 1000);
          });
