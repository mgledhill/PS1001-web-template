...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-020100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020100').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020103').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020104').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020104').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020105').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020105').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020106').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020106').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-020107').click(function () {     /* START of scroll function */
  ...
  /* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-02').click(function () {     /* START of scroll function */
