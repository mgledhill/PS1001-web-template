...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          16-05-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-160500').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--160500').offset().top -20}, 250);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-c16-04').click(function () {
       $('html, body').animate({scrollTop: $('#js--c16-04').offset().top -120}, 1000);
    });

    $('.js--sc-c16-05').click(function () {
       $('html, body').animate({scrollTop: $('#js--c16-05').offset().top -120}, 1000);
    });
