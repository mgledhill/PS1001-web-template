...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          14-02-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
20 Apr 2019   d-P19.14.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P19.14.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-140200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--140200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-140201').click(function () {
       $('html, body').animate({scrollTop: $('#js--140201').offset().top -20}, 1000);
    });

    $('.js--sc-140202').click(function () {
       $('html, body').animate({scrollTop: $('#js--140202').offset().top -20}, 1000);
    });

    $('.js--sc-140203').click(function () {
       $('html, body').animate({scrollTop: $('#js--140203').offset().top -20}, 1000);
    });

    $('.js--sc-140204').click(function () {
       $('html, body').animate({scrollTop: $('#js--140204').offset().top -20}, 1000);
    });

    $('.js--sc-140205').click(function () {
       $('html, body').animate({scrollTop: $('#js--140205').offset().top -20}, 1000);
    });

    $('.js--sc-140206').click(function () {
       $('html, body').animate({scrollTop: $('#js--140206').offset().top -20}, 1000);
    });

    $('.js--sc-140207').click(function () {
       $('html, body').animate({scrollTop: $('#js--140207').offset().top -20}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-t14-02').click(function () {
       $('html, body').animate({scrollTop: $('#js--t14-02').offset().top -60}, 1000);
    });
