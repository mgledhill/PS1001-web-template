...
23 Mar 2019   d-P13.00.04c M. Gledhill    Sections updated
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-040200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--040200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-040201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--040201').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-040202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--040202').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-t04-05').click(function () {
      $('html, body').animate({scrollTop: $('#js--t04-05').offset().top -60}, 1000);
    });
