...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-11-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-061100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-061101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-061102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061102').offset().top -20}, 1000);
    });                                         /* END of scroll function */
