...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          24-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-240100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-240101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240103').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240104').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240104').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f24-02').click(function () {
       $('html, body').animate({scrollTop: $('#js--f24-02').offset().top -80}, 1000);
    });
