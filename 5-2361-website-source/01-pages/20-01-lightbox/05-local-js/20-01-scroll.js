...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          20-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-200100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-200101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-200102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-200103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200103').offset().top -20}, 1000);
    });                                         /* END of scroll function */
