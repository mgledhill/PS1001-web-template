...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-09-SCROLL.JS
*******************************************************************************
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P13.00.04e</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060900').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060900').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060901').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060901').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060902').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060902').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060903').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060903').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060904').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060904').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060905').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060905').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060906').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060906').offset().top -20}, 1000);
    });                                         /* END of scroll function */
