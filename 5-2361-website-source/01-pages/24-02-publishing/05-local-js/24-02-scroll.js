...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          24-02-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-240200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-240201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240201').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240202').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240203').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240203').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240204').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240204').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f24-10').click(function () {
       $('html, body').animate({scrollTop: $('#js--f24-10').offset().top -80}, 1000);
    });

    $('.js--sc-f24-19').click(function () {
