...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          05-07-SCROLL.JS
*******************************************************************************
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P13.00.04d</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-050700').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050700').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050701').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050701').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050702').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050702').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050703').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050703').offset().top -20}, 1000);
    });                                         /* END of scroll function */
