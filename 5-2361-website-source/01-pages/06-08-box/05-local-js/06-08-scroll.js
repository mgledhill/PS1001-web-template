...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-08-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060800').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060800').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060801').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060801').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060802').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060802').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060803').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060803').offset().top -20}, 1000);
    });                                         /* END of scroll function */
