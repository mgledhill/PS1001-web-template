...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          19-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-190100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--190100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-190101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--190101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-190102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--190102').offset().top -20}, 1000);
    });                                         /* END of scroll function */
