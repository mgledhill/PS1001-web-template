...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          11-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-110100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-110101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110101').offset().top -20}, 1000);
    });                                         /* END of scroll function */
