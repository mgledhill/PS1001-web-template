...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          21-02-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-210200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-210201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210201').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210202').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210203').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210203').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210204').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210204').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210205').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210205').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210206').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210206').offset().top -20}, 1000);
    });                                         /* END of scroll function */
