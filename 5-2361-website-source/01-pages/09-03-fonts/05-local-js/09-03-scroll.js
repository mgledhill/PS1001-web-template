...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-090300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090300').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-090301').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090301').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-090302').click(function () {     /* START of scroll function */
