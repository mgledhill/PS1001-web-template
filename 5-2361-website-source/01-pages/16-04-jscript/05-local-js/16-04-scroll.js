...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          16-04-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-160400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--160400').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-160401').click(function () {
       $('html, body').animate({scrollTop: $('#js--160401').offset().top -20}, 1000);
    });

    $('.js--sc-160402').click(function () {
       $('html, body').animate({scrollTop: $('#js--160402').offset().top -20}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-f16-18').click(function () {
       $('html, body').animate({scrollTop: $('#js--f16-18').offset().top -80}, 1000);
    });
