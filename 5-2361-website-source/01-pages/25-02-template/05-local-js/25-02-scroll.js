...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          25-02-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-250200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--250200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-250201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--250201').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-250202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--250202').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-250203').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--250203').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-250204').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--250204').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-250205').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--250205').offset().top -20}, 1000);
    });                                         /* END of scroll function */
