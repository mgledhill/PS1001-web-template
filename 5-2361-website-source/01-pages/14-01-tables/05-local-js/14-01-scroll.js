...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          14-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-140100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--140100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-140101').click(function () {
       $('html, body').animate({scrollTop: $('#js--140101').offset().top -20}, 1000);
    });

    $('.js--sc-140102').click(function () {
       $('html, body').animate({scrollTop: $('#js--140102').offset().top -20}, 1000);
    });

    $('.js--sc-140103').click(function () {
       $('html, body').animate({scrollTop: $('#js--140103').offset().top -20}, 1000);
    });

    $('.js--sc-140104').click(function () {
       $('html, body').animate({scrollTop: $('#js--140104').offset().top -20}, 1000);
    });

    $('.js--sc-140105').click(function () {
       $('html, body').animate({scrollTop: $('#js--140105').offset().top -20}, 1000);
    });

    $('.js--sc-140106').click(function () {
       $('html, body').animate({scrollTop: $('#js--140106').offset().top -20}, 1000);
    });
