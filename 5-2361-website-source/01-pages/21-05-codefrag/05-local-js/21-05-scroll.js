...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          21-05-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-210500').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210500').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-210501').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210501').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210502').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210502').offset().top -20}, 1000);
    });                                         /* END of scroll function */
