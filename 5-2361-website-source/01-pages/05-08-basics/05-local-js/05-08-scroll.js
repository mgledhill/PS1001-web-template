...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          05-08-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-050800').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050800').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050801').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050801').offset().top -20}, 1000);
    });                                         /* END of scroll function */
