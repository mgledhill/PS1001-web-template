...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          23-03-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-230300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--230300').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-230301').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--230301').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-t23-01').click(function () {
       $('html, body').animate({scrollTop: $('#js--t23-01').offset().top -60}, 1000);
    });
