...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          16-02-SCROLL.JS
*******************************************************************************
...
27 Apr 2019   P22          M. Gledhill    Published

25 Apr 2019   d-P20.15.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P22</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-160200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--160200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-160201').click(function () {
       $('html, body').animate({scrollTop: $('#js--160201').offset().top -20}, 1000);
    });

    $('.js--sc-160202').click(function () {
       $('html, body').animate({scrollTop: $('#js--160202').offset().top -20}, 1000);
    });

    $('.js--sc-160203').click(function () {
       $('html, body').animate({scrollTop: $('#js--160203').offset().top -20}, 1000);
    });

    $('.js--sc-160204').click(function () {
       $('html, body').animate({scrollTop: $('#js--160204').offset().top -20}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-f16-04').click(function () {
       $('html, body').animate({scrollTop: $('#js--f16-04').offset().top -80}, 1000);
    });

    $('.js--sc-f16-07').click(function () {
       $('html, body').animate({scrollTop: $('#js--f16-07').offset().top -80}, 1000);
    });

    $('.js--sc-f16-11').click(function () {
       $('html, body').animate({scrollTop: $('#js--f16-11').offset().top -80}, 1000);
    });
