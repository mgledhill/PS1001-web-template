...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          07-04-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-070400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070400').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070403').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-c07-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--c07-02').offset().top -80}, 1000);
          });
