...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060400').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060402').click(function () {     /* START of scroll function */
