...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          21-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-210100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-210101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210103').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f21-02').click(function () {
       $('html, body').animate({scrollTop: $('#js--f21-02').offset().top -80}, 1000);
    });

    $('.js--sc-f21-05').click(function () {
       $('html, body').animate({scrollTop: $('#js--f21-05').offset().top -80}, 1000);
    });

    $('.js--sc-f21-12').click(function () {
       $('html, body').animate({scrollTop: $('#js--f21-12').offset().top -80}, 1000);
    });
