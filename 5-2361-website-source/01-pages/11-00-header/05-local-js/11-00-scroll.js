...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-110000').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110000').offset().top -0}, 250);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f11-01').click(function () {
       $('html, body').animate({scrollTop: $('#js--f11-01').offset().top -80}, 1000);
    });
