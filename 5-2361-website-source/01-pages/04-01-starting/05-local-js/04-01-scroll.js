...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-040100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--040100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-040101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--040101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-040102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--040102').offset().top -20}, 1000);
    });                                         /* END of scroll function */
