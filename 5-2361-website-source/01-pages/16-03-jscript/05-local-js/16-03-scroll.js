...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          16-03-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-160300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--160300').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-160301').click(function () {
       $('html, body').animate({scrollTop: $('#js--160301').offset().top -20}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-f16-15').click(function () {
       $('html, body').animate({scrollTop: $('#js--f16-15').offset().top -80}, 1000);
    });
