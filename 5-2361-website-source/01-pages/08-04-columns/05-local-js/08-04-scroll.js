...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          08-04-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-080400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--080400').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-080401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--080401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-080402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--080402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-080403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--080403').offset().top -20}, 1000);
    });                                         /* END of scroll function */
