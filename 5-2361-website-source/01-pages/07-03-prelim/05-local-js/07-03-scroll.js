...
-------------------------------------------------------------------------------
25 Mar 2019   d-P13.00.04e M. Gledhill    Sections updated
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P13.00.04f</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-070300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070300').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070301').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070301').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070302').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070302').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070303').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070303').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070304').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070304').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070305').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070305').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070306').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070306').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070307').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070307').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070308').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070308').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-070309').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070309').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-c07-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--c07-01').offset().top -80}, 1000);
          });
