...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          20-04-SCROLL.JS
*******************************************************************************
...
30 Apr 2019   P25          M. Gledhill    Published
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P25</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-200400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200400').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-200401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-200402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-200403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200403').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-200404').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200404').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f20-08').click(function () {
       $('html, body').animate({scrollTop: $('#js--f20-08').offset().top -80}, 1000);
    });
