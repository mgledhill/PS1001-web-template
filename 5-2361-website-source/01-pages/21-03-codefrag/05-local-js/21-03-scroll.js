...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          21-03-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-210300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210300').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-210301').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210301').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210302').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210302').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210303').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210303').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210304').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210304').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210305').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210305').offset().top -20}, 1000);
    });                                         /* END of scroll function */
