...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          17-03-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-170300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--170300').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-170301').click(function () {
       $('html, body').animate({scrollTop: $('#js--170301').offset().top -20}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-t17-01').click(function () {
       $('html, body').animate({scrollTop: $('#js--t17-01').offset().top -60}, 1000);
    });
