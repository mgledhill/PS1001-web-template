...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          18-02-SCROLL.JS
*******************************************************************************
...
29 Apr 2019   P24          M. Gledhill    Published
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P24</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-180200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--180200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-180201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--180201').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-180202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--180202').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f18-04').click(function () {
       $('html, body').animate({scrollTop: $('#js--f18-04').offset().top -80}, 1000);
    });

    $('.js--sc-f18-06').click(function () {
       $('html, body').animate({scrollTop: $('#js--f18-06').offset().top -80}, 1000);
    });
