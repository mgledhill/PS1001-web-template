...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          20-00-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-200000').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--200000').offset().top -0}, 250);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f18-01').click(function () {
       $('html, body').animate({scrollTop: $('#js--f18-01').offset().top -80}, 1000);
    });

    $('.js--sc-f18-02').click(function () {
       $('html, body').animate({scrollTop: $('#js--f18-02').offset().top -80}, 1000);
    });

    $('.js--sc-f18-03').click(function () {
       $('html, body').animate({scrollTop: $('#js--f18-03').offset().top -80}, 1000);
    });
