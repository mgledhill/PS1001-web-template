...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          06-10-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-061000').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061000').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-061001').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061001').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-061002').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061002').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-061003').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--061003').offset().top -20}, 1000);
    });                                         /* END of scroll function */
