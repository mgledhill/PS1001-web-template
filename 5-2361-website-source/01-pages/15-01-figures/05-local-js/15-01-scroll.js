...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          15-01-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
25 Apr 2019   P21          M. Gledhill    Published
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P21</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-150100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--150100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-150101').click(function () {
       $('html, body').animate({scrollTop: $('#js--150101').offset().top -20}, 1000);
    });

    $('.js--sc-150102').click(function () {
       $('html, body').animate({scrollTop: $('#js--150102').offset().top -20}, 1000);
    });

    $('.js--sc-150103').click(function () {
       $('html, body').animate({scrollTop: $('#js--150103').offset().top -20}, 1000);
    });
