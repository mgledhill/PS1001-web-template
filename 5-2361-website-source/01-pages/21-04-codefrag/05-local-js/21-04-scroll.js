...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          21-04-SCROLL.JS
*******************************************************************************
...
03 May 2019   P26          M. Gledhill    Published
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P26</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-210400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210400').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-210401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210403').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210404').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210404').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210405').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210405').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210406').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210406').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210407').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210407').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210408').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--210408').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-210409').click(function () {     /* START of scroll function */
