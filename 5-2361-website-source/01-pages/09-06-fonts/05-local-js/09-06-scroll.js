...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-090600').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090600').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-090601').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090601').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-090602').click(function () {     /* START of scroll function */
