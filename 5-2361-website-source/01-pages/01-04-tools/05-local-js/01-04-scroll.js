...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          01-04-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-010400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--010400').offset().top -20}, 1000);
    });                                         /* END of scroll function */

   $('.js--sc-010401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--010401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

   $('.js--sc-010402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--010402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

   $('.js--sc-010403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--010403').offset().top -20}, 1000);
    });                                         /* END of scroll function */

   $('.js--sc-010404').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--010404').offset().top -20}, 1000);
    });                                         /* END of scroll function */
