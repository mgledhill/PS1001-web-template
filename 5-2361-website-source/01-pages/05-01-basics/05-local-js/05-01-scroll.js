...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-050100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-050101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050103').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050104').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050104').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050105').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050105').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050106').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050106').offset().top -20}, 1000);
    });                                         /* END of scroll function */
