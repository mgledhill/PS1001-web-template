...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          10-09-SCROLL.JS
*******************************************************************************
...
11 Apr 2019   P16          M. Gledhill    Published

10 Apr 2019   d-P15.10.02  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P16</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-100900').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100900').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-100901').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100901').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100902').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100902').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100903').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100903').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100904').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100904').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100905').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100905').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100906').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100906').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100907').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100907').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100908').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100908').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100909').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100909').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100910').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100910').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100911').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100911').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100912').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100912').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100913').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100913').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100914').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100914').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100915').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100915').offset().top -20}, 1000);
    });                                         /* END of scroll function */
