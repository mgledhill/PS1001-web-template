...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060000').click(function () {     /* START of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060100').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060103').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060104').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060104').offset().top -20}, 1000);
    });                                         /* END of scroll function */
