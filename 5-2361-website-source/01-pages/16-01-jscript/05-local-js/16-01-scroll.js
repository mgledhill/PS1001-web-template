...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          16-01-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-160100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--160100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-160101').click(function () {
       $('html, body').animate({scrollTop: $('#js--160101').offset().top -20}, 1000);
    });

    $('.js--sc-160102').click(function () {
       $('html, body').animate({scrollTop: $('#js--160102').offset().top -20}, 1000);
    });
