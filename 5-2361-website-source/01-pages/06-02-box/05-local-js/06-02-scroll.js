...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-060200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--060200').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-060201').click(function () {     /* START of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-e06-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--e06-02').offset().top -80}, 1000);
          });
