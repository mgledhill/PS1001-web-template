...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          10-08-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-100800').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100800').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-100801').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100801').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100802').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100802').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100803').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100803').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100804').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100804').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100805').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100805').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100806').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100806').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-100807').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--100807').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-c10-14').click(function () {
       $('html, body').animate({scrollTop: $('#js--c10-14').offset().top -120}, 1000);
    });
