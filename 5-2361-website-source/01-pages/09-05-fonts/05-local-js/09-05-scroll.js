...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-090500').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090500').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-090501').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090501').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-090502').click(function () {     /* START of scroll function */
