...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-090200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090200').offset().top -20}, 250);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-t09-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--t09-01').offset().top -60}, 1000);
          });

          $('.js--sc-t09-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--t09-02').offset().top -60}, 1000);
          });
