...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          11-02-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-110200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-110201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110201').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-110202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110202').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f11-08').click(function () {
       $('html, body').animate({scrollTop: $('#js--f11-08').offset().top -80}, 1000);
    });
