...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P13.00.04g</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          ...
          $('.js--sc-c08-01').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-01').offset().top -120}, 1000);
          });

          $('.js--sc-c08-02').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-02').offset().top -120}, 1000);
          });

          $('.js--sc-c08-03').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-03').offset().top -120}, 1000);
          });

          $('.js--sc-c08-04').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-04').offset().top -120}, 1000);
          });

          $('.js--sc-c08-05').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-05').offset().top -120}, 1000);
          });

          $('.js--sc-c08-06').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-06').offset().top -120}, 1000);
          });

          $('.js--sc-c08-07').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-07').offset().top -120}, 1000);
          });

          $('.js--sc-c08-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-08').offset().top -120}, 1000);
          });

          $('.js--sc-c08-09').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-09').offset().top -120}, 1000);
          });

          $('.js--sc-c08-10').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-10').offset().top -120}, 1000);
          });

          $('.js--sc-c08-11').click(function () {
           $('html, body').animate({scrollTop: $('#js--c08-11').offset().top -120}, 1000);
          });
