...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-090100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090100').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-090101').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090101').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-090102').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090102').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-090103').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--090103').offset().top -20}, 1000);
    });                                         /* END of scroll function */
