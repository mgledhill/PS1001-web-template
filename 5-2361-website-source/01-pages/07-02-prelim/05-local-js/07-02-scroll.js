...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-070200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--070200').offset().top -20}, 500);
    });                                         /* END of scroll function */

    $('.js--sc-070201').click(function () {     /* START of scroll function */
