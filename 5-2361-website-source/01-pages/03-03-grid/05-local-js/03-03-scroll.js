...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P13.00.04b</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-030300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--030300').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-030301').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--030301').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-030302').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--030302').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-030303').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--030303').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-030303a').click(function () {
       $('html, body').animate({scrollTop: $('#js--030303a').offset().top -120}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
        ...
        $('.js--sc-t03-08').click(function () {
           $('html, body').animate({scrollTop: $('#js--t03-08').offset().top -80}, 1000);
          });
