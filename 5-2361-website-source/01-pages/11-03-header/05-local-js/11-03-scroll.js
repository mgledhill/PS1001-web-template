...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          11-03-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
10 Apr 2019   d-P16.11.01  M. Gledhill    Page created
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;d-P16.11.01</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-110300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110300').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-110301').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110301').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-110302').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110302').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-110303').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110303').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-110304').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--110304').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f11-14').click(function () {
       $('html, body').animate({scrollTop: $('#js--f11-14').offset().top -80}, 1000);
    });

    $('.js--sc-f11-15').click(function () {
       $('html, body').animate({scrollTop: $('#js--f11-15').offset().top -80}, 1000);
    });

    $('.js--sc-f11-16').click(function () {
       $('html, body').animate({scrollTop: $('#js--f11-16').offset().top -80}, 1000);
    });

    $('.js--sc-f11-20').click(function () {
       $('html, body').animate({scrollTop: $('#js--f11-20').offset().top -80}, 1000);
    });
