...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          24-04-SCROLL.JS
*******************************************************************************
...
-------------------------------------------------------------------------------
07 May 2019   P28          M. Gledhill    Published
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P28</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-240400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240400').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-240401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240401').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240403').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240404').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240404').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-240405').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--240405').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    $('.js--sc-f24-45').click(function () {
       $('html, body').animate({scrollTop: $('#js--f24-45').offset().top -80}, 1000);
    });
