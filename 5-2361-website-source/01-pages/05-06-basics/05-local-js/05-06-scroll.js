...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          05-06-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-050600').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050600').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050601').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050601').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-050602').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--050602').offset().top -20}, 1000);
    });                                         /* END of scroll function */
                                        /* END of scroll function */
