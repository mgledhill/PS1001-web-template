...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          22-04-SCROLL.JS
*******************************************************************************
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('.aside-right-rev').append (
        "<p>scroll.js&nbsp;&mdash;&nbsp;P27</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-220400').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220400').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-220401').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220401').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    ...
    $('.js--sc-220402').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220402').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-220403').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220403').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-220404').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220404').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-220405').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220405').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-220406').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--220406').offset().top -20}, 1000);
    });                                         /* END of scroll function */
